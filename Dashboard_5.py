...
if uploaded_file_1 is not None and uploaded_file_2 is not None:
    ...
    # 1. SPHs
    try:
        SPH_2019 = pd.read_csv('data/SPH_2019.csv')
        SPH_2022 = pd.read_csv('data/SPH_2022.csv')
    except:
        ...
        # 3. Save the SPH
        SPH_2019.to_csv('data/SPH_2019.csv', index=False)
        SPH_2022.to_csv('data/SPH_2022.csv', index=False)
    ...
    try:
        covers2019 = pd.read_csv('data/covers_2019.csv')
        covers2022 = pd.read_csv('data/covers_2022.csv')
    except:
        covers2019 = create_timeries_covers(df1)
        covers2022 = create_timeries_covers(df2)
        # save as csv
        covers2019.to_csv('data/covers_2019.csv', index=True)
        covers2022.to_csv('data/covers_2022.csv', index=True)
    ...
    # ----------------- #
        ...
        data_2019 = pd.read_csv('data/covers_2019.csv')
        data  = data_2019.copy()
        # sort data
